...
export default function Shop() {
  ...
  const load = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const [prods, svcs, brand] = await Promise.all([catalogAPI.getProducts({ company_id: companyId }), catalogAPI.getServices({ company_id: companyId }), companiesAPI.getBranding(companyId).catch(() => null)]);
      setProducts(prods);
      setServices(svcs);

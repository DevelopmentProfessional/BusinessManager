...
export default function BookingConfirmation({ service, slot, onClose, onViewBookings }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center p-1">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-1 flex flex-col items-center text-center">
        ...
        <div className="w-full bg-gray-50 rounded-xl p-1 mb-6 text-left space-y-2">
          ...
          <div className="pl-1">
            <span className={`inline-block text-xs font-medium px-0 py-0.5 rounded-full ${

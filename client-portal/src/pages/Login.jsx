...
export default function Login() {
  ...
  useEffect(() => {
    ...
    companiesAPI.getBranding(preselected.company_id)
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            borderRadius: '0.5rem', padding: '6px 10px',
        ...
        {preselected ? (
          <div style={{ position: 'relative' }}>
            ...
            <h1 style={{ color: '#fff', fontWeight: 800, fontSize: '1.4rem', margin: 0 }}>
              {branding?.portal_hero_title || preselected.name}
            </h1>
            <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: '0.85rem', margin: '4px 0 0' }}>
              {branding?.portal_hero_subtitle || 'Sign in to your account'}
            </p>
          </div>
        ) : (
          <div style={{ position: 'relative' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            {error && (
              <div style={{
                ...
                borderRadius: '0.6rem', padding: '10px 12px',

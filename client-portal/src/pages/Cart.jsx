  ...
  return (
    <Layout>
      <div style={{ padding: "20px 16px", paddingBottom: "5.5rem", maxWidth: 600, margin: "0 auto" }}>
        <h2 style={{ fontSize: "1.1rem", fontWeight: 800, color: "#111827", marginBottom: 16 }}>Your Cart</h2>
        ...
        <div style={{ marginBottom: 16 }}>
          {cart.map((item) => (
            ...
            >
              ...
              >
                {item.image_url ? <img src={item.image_url} alt={item.name} style={{ width: "100%", height: "100%", objectFit: "cover" }} /> : <span style={{ color: "#fff", fontWeight: 800, fontSize: "1.1rem" }}>{item.name?.[0]}</span>}
              </div>
        ...
        {!currentOrderId && (
          ...
          >
            ...
            {!isOnline && <div style={{ background: "#fef3c7", color: "#92400e", borderRadius: "0.5rem", padding: "8px 12px", fontSize: "0.78rem", marginBottom: 12 }}>You're offline. Connect to the internet to checkout.</div>}

            {error && <div style={{ background: "#fef2f2", color: "#dc2626", borderRadius: "0.5rem", padding: "8px 12px", fontSize: "0.78rem", marginBottom: 12 }}>{error}</div>}
        ...
        {currentOrderId && (
          ...
          >
            ...
            <p style={{ textAlign: "center", fontSize: "0.82rem", color: "#6b7280", marginBottom: 16 }}>Your order has been submitted. Complete payment to confirm.</p>

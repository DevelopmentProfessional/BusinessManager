...
export default function Layout({ children }) {
  ...
  return (
    <div className="app-shell bg-body d-flex flex-column">
      {/* Offline banner */}
      {!isOnline && (
        <div className="position-absolute start-0 end-0 top-0 d-flex align-items-center justify-content-center gap-2 px-3 py-2 text-sm" style={{ zIndex: 2000, backgroundColor: "#f59e0b", color: "#1c1917" }}>
      ...
      <main className="app-shell-main flex-grow-1 d-flex flex-column min-h-0 overflow-hidden" style={!isOnline ? { paddingTop: "2rem" } : undefined}>
        {children}
      </main>

/**
 * Image_Resizable — Custom Tiptap image extension with:
 ...
 *
 * Replaces the stock @tiptap/extension-image in Editor_RichText.
 */
...
export const Image_Resizable = Node.create({
  name: "image",
  group: "block",
  atom: true,
  draggable: true,
...
export default Image_Resizable;

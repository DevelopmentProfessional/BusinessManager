...
export default function Modal_ForecastCalculator({ isOpen, onClose }) {
  ...
  }, [monteCarloEnabled, monteCarloRuns, variancePercent, revenueGrowthRate, productPrice, unitsPerPeriod, timeView, forecastData.baseRevenue, forecastData.baseExpenses]);
  ...
  }, [sensitivityEnabled, forecastData, productPrice, unitsPerPeriod, revenueGrowthRate, cogsPerUnit, unitsPerBatch, batchFrequency, fixedMonthlyCosts]);
  ...
  }, [isOpen, scenarioName, timeView, startDate, revenueGrowthRate, discountRate, initialInvestment, productPrice, unitsPerPeriod, cogsPerUnit, marketingBudget, fixedMonthlyCosts, inflationRate, churnRate, variancePercent]);
  ...
  const exportPdfReport = () => {
    ...
    const periodRows = forecastData.labels
      .map((label, idx) => {
                          ...
                          <div className="bg-gray-50 dark:bg-gray-800 rounded p-2">
                            {oneTimePayments.map((payment, idx) => (
                              <div key={idx} className="d-flex justify-content-between align-items-center text-xs mb-1">
                                ...
                                <button onClick={() => removeOneTimePayment(idx)} className="btn btn-link btn-sm p-0 text-danger">
                          ...
                          <div className="bg-gray-50 dark:bg-gray-800 rounded p-2">
                            {recurringPayments.map((payment, idx) => (
                              <div key={idx} className="d-flex justify-content-between align-items-center text-xs mb-1">
                                ...
                                <button onClick={() => removeRecurringPayment(idx)} className="btn btn-link btn-sm p-0 text-danger">
                                  <XMarkIcon className="h-3 w-3" />
                                </button>
                              </div>
                            ))}
                      ...
                      <div className="row g-2">
                        ...
                        <div className="col-12">
                          <div className="form-check mb-2">
                            <input type="checkbox" checked={seasonalityEnabled} onChange={(e) => setSeasonalityEnabled(e.target.checked)} className="form-check-input" id="seasonalityCheck" />
                  ...
                  {showRiskSection && (
                    <div className="p-3 border-top border-gray-200 dark:border-gray-700">
                      <div className="row g-2">
                        ...
                        <div className="col-12">
                          <div className="form-check mb-2">
                            <input type="checkbox" checked={scenarioEnabled} onChange={(e) => setScenarioEnabled(e.target.checked)} className="form-check-input" id="scenarioCheck" />
                        ...
                        <div className="col-12">
                          <div className="form-check mb-2">
                            <input type="checkbox" checked={monteCarloEnabled} onChange={(e) => setMonteCarloEnabled(e.target.checked)} className="form-check-input" id="monteCarloCheck" />
                        ...
                        <div className="col-12">
                          <div className="form-check mb-2">
                            <input type="checkbox" checked={sensitivityEnabled} onChange={(e) => setSensitivityEnabled(e.target.checked)} className="form-check-input" id="sensitivityCheck" />

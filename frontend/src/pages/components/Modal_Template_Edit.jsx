  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-white dark:bg-gray-900" style={{ fontFamily: "inherit" }}>
      ...
      <div className="flex-shrink-0 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
        ...
        <EditorToolbar editorType="richtext" editor={editorInstance} onSave={handleSave} onUndo={handleUndo} onRedo={handleRedo} isDirty={isDirty} isSaving={saving} saveStatus={saveStatus} showDesignTab={false} />
        ...
        {/* Row 3: actions */}
        <div className="px-3 pt-2 pb-4 border-t border-gray-200 dark:border-gray-700 align-items-center gap-2" style={{ display: "grid", gridTemplateColumns: "1fr auto 1fr" }}>

    ...
    return (
      <div className="fixed inset-0 z-50">
        ...
        <div className="fixed inset-0 flex flex-col bg-white dark:bg-gray-900">
          ...
          <div className={`${noPadding ? '' : 'p-2'} flex-1 overflow-auto no-scrollbar text-gray-900 dark:text-gray-100`}>{children}</div>
          {footer && (
      ...
      <div className="fixed inset-0 z-50 overflow-y-auto">
        <div className="flex items-center justify-center min-h-full p-4">
          ...
          <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col overflow-hidden">
            ...
            <div className={`flex-1 overflow-y-auto no-scrollbar ${noPadding ? '' : 'px-4 py-4'}`}>
    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-end justify-center min-h-screen">
        ...
        <div className="fixed bottom-0 left-0 right-0 w-full bg-white dark:bg-gray-800 rounded-t-lg text-left overflow-hidden shadow-xl transform transition-all border-t border-gray-200 dark:border-gray-700 max-h-screen flex flex-col">
          ...
          <div className={`flex-1 overflow-y-auto no-scrollbar bg-white dark:bg-gray-800 ${noPadding ? '' : 'px-3 py-3'}`}>
            <div className="text-gray-900 dark:text-gray-100">{children}</div>
          </div>
          {footer && (

...
export default function Footer_Settings({ onSave, onClose, saveLabel = "Save", saving = false, saveDisabled = false, className = "" }) {
  return (
    <footer className={`app-footer-shell flex-shrink-0 border-top border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 app-footer-padding app-form-footer ${className}`.trim()}>
      <Footer_Actions

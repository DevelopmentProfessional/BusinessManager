  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex-1 overflow-hidden">
        ...
        >
          {editorType === "richtext" ? <RichTextEditor ref={editorCallbackRef} content={content} onChange={setContent} /> : <CodeEditor ref={editorCallbackRef} content={content} onChange={setContent} language={codeLanguage || "text"} />}
        </Suspense>
      </div>
      <EditorToolbar editorType={editorType} editor={editorInstance} onSave={saveContent} onUndo={handleUndo} onRedo={handleRedo} isDirty={isDirty} isSaving={isSaving} saveStatus={saveStatus} />
    </div>
  );
}
    ...
    <Modal isOpen={isOpen && !!document} onClose={handleClose} noPadding={true} fullScreen={true}>
      <div className="absolute inset-0 m-2 sm:m-4 lg:m-6 flex flex-col bg-white dark:bg-gray-800 rounded-lg shadow-xl overflow-hidden">
        ...
        <div className="flex items-center justify-between px-4 py-2 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
          ...
          <div className="flex items-center gap-2">
            <button type="button" onClick={handleClose} className="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 rounded d-flex align-items-center justify-content-center" style={{ width: "3rem", height: "3rem" }}>

    ...
    <div className="space-y-4">
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
        <div className="flex items-start gap-2">
          ...
          <div className="text-sm text-blue-800 dark:text-blue-300">This section displays API configuration and connection status. Use this to troubleshoot connectivity issues.</div>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <div className="grid grid-cols-2 gap-4">
          <div className="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
            ...
            <p className="text-sm font-mono text-gray-900 dark:text-white break-all">{api.defaults.baseURL}</p>
          </div>
          <div className="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Hostname</p>
            <p className="text-sm font-mono text-gray-900 dark:text-white">{window.location.hostname}</p>
          </div>
          <div className="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Protocol</p>
            <p className="text-sm font-mono text-gray-900 dark:text-white">{window.location.protocol}</p>
          </div>
          <div className="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Port</p>
            <p className="text-sm font-mono text-gray-900 dark:text-white">{window.location.port || "default"}</p>
          </div>
          <div className="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg col-span-2">
            ...
            <p className="text-sm font-mono text-gray-900 dark:text-white">{import.meta.env.VITE_API_URL || "not set"}</p>
          </div>
        </div>

        <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
          <h3 className="font-medium text-gray-900 dark:text-white mb-3">Connection Test</h3>
          <button onClick={testApiConnection} disabled={apiStatus === "testing"} className="bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white px-4 py-2 rounded-lg transition-colors disabled:cursor-not-allowed">

        ...
        <div className="flex items-center justify-between px-4 py-2 bg-white border-b border-gray-200">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              className="px-3 py-1.5 text-sm rounded border bg-white border-gray-300 text-gray-700 hover:bg-gray-50 transition-colors"
              title="Download"
            >
            ...
            <button
              onClick={handleSave}
              disabled={isSaving}
              className="px-4 py-1.5 text-sm rounded bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center"
              title="Save"
            >
              {isSaving ? (
                <>

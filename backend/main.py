...
try:
    from backend.routers import auth, isud, settings, database_connections, tasks, reports, leave_requests, payroll, chat, templates, features, client_cart, portal_orders, production, assets, products, inventory_categories, document_tags, workflows, audit, financial
    ...
    if getattr(e, "name", None) in {"backend.routers", "backend.routers.auth", "backend.routers.isud", "backend.routers.settings", "backend.routers.database_connections", "backend.routers.tasks", "backend.routers.reports", "backend.routers.leave_requests", "backend.routers.payroll", "backend.routers.chat", "backend.routers.templates", "backend.routers.features", "backend.routers.client_cart", "backend.routers.portal_orders", "backend.routers.production", "backend.routers.assets", "backend.routers.products", "backend.routers.inventory_categories", "backend.routers.document_tags", "backend.routers.workflows", "backend.routers.audit", "backend.routers.financial"}:
        from routers import auth, isud, settings, database_connections, tasks, reports, leave_requests, payroll, chat, templates, features, client_cart, portal_orders, production, assets, products, inventory_categories, document_tags, workflows, audit, financial  # type: ignore
    else:
        raise

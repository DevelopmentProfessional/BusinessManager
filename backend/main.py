...
try:
    from backend.routers import auth, isud, settings, database_connections, tasks, reports, leave_requests, payroll, chat, templates, regtest, features, client_cart, production, assets
    ...
    if getattr(e, "name", None) in {"backend.routers", "backend.routers.auth", "backend.routers.isud", "backend.routers.settings", "backend.routers.database_connections", "backend.routers.tasks", "backend.routers.reports", "backend.routers.leave_requests", "backend.routers.payroll", "backend.routers.chat", "backend.routers.templates", "backend.routers.regtest", "backend.routers.features", "backend.routers.client_cart", "backend.routers.production", "backend.routers.assets"}:
        from routers import auth, isud, settings, database_connections, tasks, reports, leave_requests, payroll, chat, templates, regtest, features, client_cart, production, assets  # type: ignore
    else:
        raise
